...
class Electricity
  {
    public static void main(String args[])
    {
        ...
        if(units<50)
        {
            System.out.println("billtopay=units*0.50"); 
        }
        else if(units<150)
        {
           System.out.println(" billtopay=(50*0.50)+((units-100)*0.75)");
        }
        else if(units<250)
        {
            System.out.println("billtopay=(50*0.50)+(50*0.75)+((units-150)*1.20)");
        }
        else
        {
            System.out.println("billtopay=(50*0.50)+(50*0.75)*((units-200)*1.50)");
        }
